...
import * as T from "../threeJS/build/three.module.js";
...
export class GrWorld {
  ...
  animate(callbacks = {}) {
    ...
    if (!this.runbutton || this.runbutton.checked) {
      ...
      const DAY_LENGTH_SECONDS = 20 * 60; // 20 minutes
      const timeSpeed = 24 / DAY_LENGTH_SECONDS;

      this.lastTimeOfDay =
        (this.lastTimeOfDay + (delta / 1000) * timeSpeed * speed) % 24;
